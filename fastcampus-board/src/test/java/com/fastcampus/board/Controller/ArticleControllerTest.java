...
import com.fastcampus.board.controller.ArticleController;
...
class ArticleControllerTest {
    ...
    @Disabled("구현 중")
    @DisplayName("[view] [GET] 게시글 리스트 상세 페이지 - 정상호출")
    @Test
    ...
    @Disabled("구현 중")
    @DisplayName("[view] [GET] 게시글 리스트 검색 전용 페이지 - 정상호출")
    @Test
    ...
    @Test
    public void givenNoting_whenRequestingArticleHashSearchView_thenReturnsArticleHashSearchView() throws Exception {
        //Given
